...
int pio_int_a = 0, pio_int_b = 0, int_38 = 0, add_isr = 0, pio_a_counter = 0, pio_b_counter = 0; 
...
char a, data[10];    
int int_38_count = 0, port_b = 0, couter_1 = 0 ;     
system_init();
